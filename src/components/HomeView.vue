              ...
              <div class="px-12 lg:px-0">
                ...
                <div class="max-w-md mx-auto w-full lg:max-w-md">
                  <label for="search" class="sr-only"
                    >Busca un servicios a pagar</label
                  >
                  <div class="relative text-white focus-within:text-gray-600">
                    ...
                    <input
                      ...
                      placeholder="Busca un servicio a pagar"
                      type="search"
                      name="search"
                    />
                  </div>
...
import ListPaymentsModal from "./ListPayments.vue";
import { ref } from "vue";
import {
  Popover,
  PopoverButton,
...
const openModalPay = (action) => {
  currentInvoice.value = action;
...
const openModalPayment = (value) => {
  openModalPays.value = value;
};

const currentInvoice = ref({});
const openModal = ref(false);
const openModalPays = ref(false);
const user = {

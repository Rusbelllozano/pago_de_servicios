        ...
        <div class="relative flex flex-wrap items-center justify-center lg:justify-between">
          ...
          <div class="absolute left-0 py-5 flex-shrink-0 lg:static">
            <a class="flex gap-4" href="#">
              ...
              <h3 class="text-lg text-white font-bold">Pago de servicios</h3>
            </a>
          </div>
        ...
        <div class="grid grid-cols-1 gap-4 items-start lg:grid-cols-3 lg:gap-8">
                  ...
                  <div class="sm:flex sm:items-center sm:justify-between">
                    <div class="sm:flex sm:space-x-5">
                      ...
                      <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                        <p class="text-sm font-medium text-gray-600">Bienvenido de vuelta,</p>
          ...
          <div class="grid grid-cols-1 gap-4">
            ...
            <section aria-labelledby="announcements-title">
              <div class="rounded-lg bg-white overflow-hidden shadow">
                <div class="p-6">
                  <h2 class="text-base font-medium text-gray-900" id="announcements-title">Pagos realizados</h2>
                  ...
                  <div class="mt-6">
                    <a href="#" class="w-full flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"> Ver todos </a>
                  </div>
                </div>
              </div>
            </section>
...
const stats = [
  { label: 'Facturas pagadas', value: 12 },
  { label: 'Pagos pendientes', value: 4 },
  { label: 'Filas ahorradas', value: 10 },
]
const actions = [
  {
    icon: TrashIcon,
    name: 'Pagar Recolección de basura',
    href: '#',
  ...
  {
    icon: PhoneIcon,
    name: 'Pagar Tigo Movil',
    href: '#',
    iconForeground: 'text-sky-700',
    iconBackground: 'bg-sky-50',
  },
  { icon: FireIcon, name: 'Pagar Gas', href: '#', iconForeground: 'text-yellow-700', iconBackground: 'bg-yellow-50' },
]
const announcements = [
  {
    id: 1,
    title: 'Pago de Acueducto y Alcantarillado',
    href: '#',
    preview:
      '- $50.000',
  },
